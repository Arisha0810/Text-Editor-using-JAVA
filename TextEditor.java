...
/*
<applet  code=javamp.class width=400 height=200>
</applet>
*/
...
public class TextEditor extends Frame {
  ...
  class Open implements ActionListener {
     ...
     * dn=fd.getDirectory(); setTitle(filename+" - Wenben"); readFile(); }
     * txt.requestFocus(); }
     */
    public void actionPerformed(ActionEvent ope) {
      ...
      if (fDialog.getFile() != null) {
        ...
        setTitle(fDialog.getFile() + " - Wenben");
        ReadFile();
      }
      txt.requestFocus();
    }
